...
![Extension settings panel showing all configuration options](https://github.com/arbs-io/github-copilot-llm-gateway/raw/HEAD/assets/screenshot-settings.png)

> **Note**: If the server is unreachable, you'll see an error notification with a quick link to settings:
>
> ![Connection error notification](https://github.com/arbs-io/github-copilot-llm-gateway/raw/HEAD/assets/screenshot-notification.png)
...
![Model manager showing LLM Gateway alongside other providers](https://github.com/arbs-io/github-copilot-llm-gateway/raw/HEAD/assets/screenshot-manage-language-model.png)

4. Select **"LLM Gateway"** from the provider list
5. Enable the models you want to use from your inference server

![Selecting Qwen3-8B from the model list](https://github.com/arbs-io/github-copilot-llm-gateway/raw/HEAD/assets/screenshot-use-qwen3.png)
...
![Copilot Chat using Qwen3-8B with full agentic capabilities](https://github.com/arbs-io/github-copilot-llm-gateway/raw/HEAD/assets/screenshot-chat.png)
...
MIT License — see [LICENSE](https://github.com/arbs-io/github-copilot-llm-gateway/blob/HEAD/LICENSE) for details.
